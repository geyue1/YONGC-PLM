/**
 * ext.yongc.plm.promotion.forms.filters.CreateGYDocPromotionFilter.java
 * @Author yge
 * 2017年7月21日下午5:09:50
 * Comment 
 */
...
public class CreateGYDocPromotionFilter extends DefaultSimpleValidationFilter{
	public UIValidationStatus preValidateAction(UIValidationKey uivalidationkey,
        ...
        if(obj instanceof WTDocument){
        	...
        	try {
				...
				if(type.indexOf(TypeConstants.DOC_GY)>-1 && doc.getState().toString().equalsIgnoreCase("INWORK")){
