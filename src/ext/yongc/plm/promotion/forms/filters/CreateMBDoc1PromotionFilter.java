/**
 * ext.yongc.plm.promotion.forms.filters.CreateMBDoc1PromotionFilter.java
 * @Author yge
 * 2017年7月21日下午5:47:02
 * Comment 
 */
...
public class CreateMBDoc1PromotionFilter extends DefaultSimpleValidationFilter{
	public UIValidationStatus preValidateAction(UIValidationKey uivalidationkey,
        ...
        if(obj instanceof WTDocument){
        	...
        	try {
				...
				if(type.indexOf(TypeConstants.DOC_MB1)>-1 && doc.getState().toString().equalsIgnoreCase("INWORK")){
