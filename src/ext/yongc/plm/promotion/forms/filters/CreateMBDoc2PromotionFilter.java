/**
 * ext.yongc.plm.promotion.forms.filters.CreateMBDoc2PromotionFilter.java
 * @Author yge
 * 2017年7月21日下午5:47:35
 * Comment 
 */
...
public class CreateMBDoc2PromotionFilter extends DefaultSimpleValidationFilter{
	public UIValidationStatus preValidateAction(UIValidationKey uivalidationkey,
        ...
        if(obj instanceof WTDocument){
        	...
        	try {
				...
				if(type.indexOf(TypeConstants.DOC_MB2)>-1 && doc.getState().toString().equalsIgnoreCase("INWORK")){
