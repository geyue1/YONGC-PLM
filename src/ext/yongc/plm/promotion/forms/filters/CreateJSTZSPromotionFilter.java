/**
 * ext.yongc.plm.promotion.forms.filters.CreateJSTZSPromotionFilter.java
 * @Author yge
 * 2017年9月19日上午9:47:16
 * Comment 
 */
...
public class CreateJSTZSPromotionFilter extends DefaultSimpleValidationFilter{
	public UIValidationStatus preValidateAction(UIValidationKey uivalidationkey,
        ...
        if(obj instanceof WTDocument){
        	...
        	try {
				...
				if(type.indexOf(TypeConstants.DOC_YF_JSTZS)>-1&& state.equalsIgnoreCase("INWORK")){
