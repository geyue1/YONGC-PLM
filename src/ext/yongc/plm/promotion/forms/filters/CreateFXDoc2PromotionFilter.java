/**
 * ext.yongc.plm.promotion.forms.filters.CreateFXDoc2PromotionFilter.java
 * @Author yge
 * 2017年7月21日下午5:36:32
 * Comment 
 */
...
public class CreateFXDoc2PromotionFilter extends DefaultSimpleValidationFilter{
	public UIValidationStatus preValidateAction(UIValidationKey uivalidationkey,
        ...
        if(obj instanceof WTDocument){
        	...
        	try {
				...
				if(type.indexOf(TypeConstants.DOC_FX2)>-1 && doc.getState().toString().equalsIgnoreCase("INWORK")){
