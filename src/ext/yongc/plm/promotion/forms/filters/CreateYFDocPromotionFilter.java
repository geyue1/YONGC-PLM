/**
 * ext.yongc.plm.promotion.forms.filters.CreateYFDocPromotionFilter.java
 * @Author yge
 * 2017年7月21日下午4:50:52
 * Comment 
 */
...
public class CreateYFDocPromotionFilter extends DefaultSimpleValidationFilter{
        ...
        if(obj instanceof WTDocument){
        	...
        	try {
				...
				if(type.indexOf(TypeConstants.DOC_YF)>-1 && !type.contains(TypeConstants.DOC_YF_TYML) && 
						...
						!type.contains(TypeConstants.DOC_YF_ZYDFJ) && state.equalsIgnoreCase("INWORK")){
