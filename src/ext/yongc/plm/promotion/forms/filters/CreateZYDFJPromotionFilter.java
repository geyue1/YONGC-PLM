/**
 * ext.yongc.plm.promotion.forms.filters.CreateZYDFJPromotionFilter.java
 * @Author yge
 * 2017年9月21日上午10:56:12
 * Comment 
 */
...
public class CreateZYDFJPromotionFilter extends DefaultSimpleValidationFilter{
	public UIValidationStatus preValidateAction(UIValidationKey uivalidationkey,
        ...
        if(obj instanceof WTDocument){
        	...
        	try {
				...
				if(type.indexOf(TypeConstants.DOC_YF_ZYDFJ)>-1 && doc.getState().toString().equalsIgnoreCase("INWORK")){
