/**
 * ext.yongc.plm.promotion.forms.filters.CreateGZDocPromotionFilter.java
 * @Author yge
 * 2017年7月21日下午5:24:38
 * Comment 
 */
...
public class CreateGZDocPromotionFilter extends DefaultSimpleValidationFilter{
	public UIValidationStatus preValidateAction(UIValidationKey uivalidationkey,
        ...
        if(obj instanceof WTDocument){
        	...
        	try {
				...
				if(type.indexOf(TypeConstants.DOC_GZ)>-1 && doc.getState().toString().equalsIgnoreCase("INWORK")){
