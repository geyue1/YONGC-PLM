/**
 * ext.yongc.plm.promotion.forms.filters.CreateTYWJMLPromotionFilter.java
 * @Author yge
 * 2017年9月18日下午4:19:00
 * Comment 
 */
...
public class CreateTYWJMLPromotionFilter extends DefaultSimpleValidationFilter{
	public UIValidationStatus preValidateAction(UIValidationKey uivalidationkey,
        ...
        if(obj instanceof WTDocument){
        	...
        	try {
				...
				if((type.indexOf(TypeConstants.DOC_YF_TYML)>-1|| type.indexOf(TypeConstants.DOC_YF_WJML)>-1 )&& 
						state.equalsIgnoreCase("INWORK")){
