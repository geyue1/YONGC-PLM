/**
 * ext.yongc.plm.change.forms.filters.CreateGYDocChangeOrder2Filter.java
 * @Author yge
 * 2017年8月25日上午9:38:52
 * Comment 
 */
...
public class CreateGYDocChangeOrder2Filter extends DefaultSimpleValidationFilter{
	public UIValidationStatus preValidateAction(UIValidationKey uivalidationkey,
        ...
        if(obj instanceof WTDocument){
        	...
        	try {
				...
				if(type.indexOf(TypeConstants.DOC_GY)>-1&& doc.getState().toString().equalsIgnoreCase("RELEASED")){
