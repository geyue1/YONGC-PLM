/**
 * ext.yongc.plm.change.forms.filters.CreateFX1DocChangeOrder2Filter.java
 * @Author yge
 * 2017年8月25日上午9:37:41
 * Comment 
 */
...
public class CreateFX1DocChangeOrder2Filter extends DefaultSimpleValidationFilter{
	public UIValidationStatus preValidateAction(UIValidationKey uivalidationkey,
        ...
        if(obj instanceof WTDocument){
        	...
        	try {
				...
				if(type.indexOf(TypeConstants.DOC_FX1)>-1&& doc.getState().toString().equalsIgnoreCase("RELEASED")){
