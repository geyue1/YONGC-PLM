/**
 * ext.yongc.plm.change.forms.filters.CreateMB1DocChangeOrder2Filter.java
 * @Author yge
 * 2017年8月23日下午5:06:22
 * Comment 
 */
...
public class CreateMB1DocChangeOrder2Filter extends DefaultSimpleValidationFilter{
	public UIValidationStatus preValidateAction(UIValidationKey uivalidationkey,
        ...
        if(obj instanceof WTDocument){
        	...
        	try {
				...
				if(type.indexOf(TypeConstants.DOC_MB1)>-1&& doc.getState().toString().equalsIgnoreCase("RELEASED")){
