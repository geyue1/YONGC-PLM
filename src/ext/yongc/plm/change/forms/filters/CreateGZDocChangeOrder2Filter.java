/**
 * ext.yongc.plm.change.forms.filters.CreateGZDocChangeOrder2Filter.java
 * @Author yge
 * 2017年8月25日上午9:42:16
 * Comment 
 */
...
public class CreateGZDocChangeOrder2Filter extends DefaultSimpleValidationFilter{
	public UIValidationStatus preValidateAction(UIValidationKey uivalidationkey,
        ...
        if(obj instanceof WTDocument){
        	...
        	try {
				...
				if(type.indexOf(TypeConstants.DOC_GZ)>-1&& doc.getState().toString().equalsIgnoreCase("RELEASED")){
