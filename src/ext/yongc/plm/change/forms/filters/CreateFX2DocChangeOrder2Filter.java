/**
 * ext.yongc.plm.change.forms.filters.CreateFX2DocChangeOrder2Filter.java
 * @Author yge
 * 2017年8月25日上午9:38:17
 * Comment 
 */
...
public class CreateFX2DocChangeOrder2Filter extends DefaultSimpleValidationFilter{
	public UIValidationStatus preValidateAction(UIValidationKey uivalidationkey,
        ...
        if(obj instanceof WTDocument){
        	...
        	try {
				...
				if(type.indexOf(TypeConstants.DOC_FX2)>-1&& doc.getState().toString().equalsIgnoreCase("RELEASED")){
