...
<table>
	<tr>
		<td class="STYLE3" nowrap="nowrap">文件目录报表</td>
	</tr>
</table>
...
<table border="0">
	...
	<tr>
		<input type="hidden" id="reportid" name="reportid" value="wenjianmuluReport"/>
	</tr>
	<tr>
		<td nowrap="nowrap">
...
<script language='JavaScript'>
	function downloadReport(){
		...
		var url = getBaseHref() + "netmarkets/jsp/ext/yongc/plm/report/downloadWenjianmulu.jsp";
