...
String objNumber = "";
boolean flag = false;
if(oid!=null && oid.contains("wt.epm.EPMDocument")){
	EPMDocument epm =(EPMDocument) new ReferenceFactory().getReference(oid).getObject();
...
<table>
	<tr>
		<td class="STYLE3" nowrap="nowrap">图样目录</td>
	</tr>
</table>
...
<table border="0">
	...
	<tr>
		<input type="hidden" id="reportid" name="reportid" value="tuyangmuluReport"/>
	</tr>
	<tr>
		<td nowrap="nowrap">
	...
	<tr>
		...
		<td>
			<input type="radio" name="objType" value="CN" id="objType" checked="checked">中文
			<input type="radio" name="objType" value="EN" id="objType">中英文
		</td>
	</tr>
	<tr><td nowrap="nowrap" colspan="3"><br/></td></tr>
	<tr>	
...
<script language='JavaScript'>
	function downloadReport(){
		...
		var url = getBaseHref() + "netmarkets/jsp/ext/yongc/plm/report/downloadTuyangmulu.jsp";
