<%@page import="com.ptc.windchill.uwgm.proesrv.request.requestResource"%>
...
//
 String workitemOid =myNmWorkItem.getOid().toString();
...
function setFolderPath(){
	var folderPath = document.getElementById('LocationPicker').value;
	var workitemOid = "<%=workitemOid%>";
	if(folderPath==null || folderPath==""){
		alert("请设置外购件入库文件夹");
		return false;
	}else{
		Ext.Ajax.request({
			url : getBaseHref()+"netmarkets/jsp/yjpart/setWGJFolderPath.jsp",
			params : {"folderPath":folderPath,"workitemOid":workitemOid},
			success:function(x){}
	    });
	}
}
