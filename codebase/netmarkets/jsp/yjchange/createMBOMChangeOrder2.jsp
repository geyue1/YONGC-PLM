...
<%
     String changeType = TypeConstants.ECN_MBOM;
     ...
     String doc_type = TypeIdentifierUtilityHelper.service.getTypeIdentifier(part).getTypename();
 ...
 boolean flag = false;
    ...
    if(flag){
    	...
    	<script >
    	   var n = '<%=number%>';
           alert("该部件已经存在正在走流程的变更单:"+n+",不能继续创建新的变更单！");
           window.close();
       </script>
