...
for(int i=0;i<NameRuleConstants.FIRST.length;i++){
	String s = NameRuleConstants.FIRST[i];
	String s2= NameRuleConstants.FIRST_zh_CN[i];
...
String third_name = df.format(new Date());
...
function getSecondName(){
	...
	Ext.Ajax.request({
		url : getBaseHref()+"netmarkets/jsp/yjchange/getCount.jsp",
		params : {"name":name},
		success:function(x){
